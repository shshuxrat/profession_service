...
type PositionServiceClient interface {
	Create(ctx context.Context, in *CreatePosition, opts ...grpc.CallOption) (*PositionId, error)
	GetAll(ctx context.Context, in *GetAllPositionRequest, opts ...grpc.CallOption) (*GetAllPositionResponse, error)
	GetById(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*GetPosition, error)
	Update(ctx context.Context, in *Position, opts ...grpc.CallOption) (*AfterUpdatePosition, error)
	Delete(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*IsDeleted, error)
}
...
func (c *positionServiceClient) Create(ctx context.Context, in *CreatePosition, opts ...grpc.CallOption) (*PositionId, error) {
	out := new(PositionId)
...
func (c *positionServiceClient) GetById(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*GetPosition, error) {
	out := new(GetPosition)
	err := c.cc.Invoke(ctx, "/genproto.PositionService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *positionServiceClient) Update(ctx context.Context, in *Position, opts ...grpc.CallOption) (*AfterUpdatePosition, error) {
	out := new(AfterUpdatePosition)
...
func (c *positionServiceClient) Delete(ctx context.Context, in *PositionId, opts ...grpc.CallOption) (*IsDeleted, error) {
	out := new(IsDeleted)
...
type PositionServiceServer interface {
	Create(context.Context, *CreatePosition) (*PositionId, error)
	GetAll(context.Context, *GetAllPositionRequest) (*GetAllPositionResponse, error)
	GetById(context.Context, *PositionId) (*GetPosition, error)
	Update(context.Context, *Position) (*AfterUpdatePosition, error)
	Delete(context.Context, *PositionId) (*IsDeleted, error)
...
func (UnimplementedPositionServiceServer) Create(context.Context, *CreatePosition) (*PositionId, error) {
...
func (UnimplementedPositionServiceServer) GetById(context.Context, *PositionId) (*GetPosition, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedPositionServiceServer) Update(context.Context, *Position) (*AfterUpdatePosition, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedPositionServiceServer) Delete(context.Context, *PositionId) (*IsDeleted, error) {
...
func _PositionService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.PositionService/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
